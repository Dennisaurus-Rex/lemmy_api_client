...
class _$_PersonSafe extends _PersonSafe {
  ...
  @override
  String toString() {
    return 'PersonSafe(id: $id, name: $name, displayName: $displayName, avatar: $avatar, banned: $banned, published: $published, updated: $updated, actorId: $actorId, bio: $bio, local: $local, banner: $banner, deleted: $deleted, matrixUserId: $matrixUserId, admin: $admin, botAccount: $botAccount, banExpires: $banExpires, instanceId: $instanceId)';
  }
...
abstract class _PersonSafe extends PersonSafe {
  const factory _PersonSafe(
      ...
      final DateTime? banExpires,
      required final int instanceId}) = _$_PersonSafe;
...
class _$_Post extends _Post {
  ...
  @override
  String toString() {
    return 'Post(apId: $apId, body: $body, communityId: $communityId, creatorId: $creatorId, deleted: $deleted, embedDescription: $embedDescription, embedTitle: $embedTitle, embedVideoUrl: $embedVideoUrl, featuredCommunity: $featuredCommunity, featuredLocal: $featuredLocal, id: $id, languageId: $languageId, local: $local, locked: $locked, name: $name, nsfw: $nsfw, published: $published, removed: $removed, thumbnailUrl: $thumbnailUrl, updated: $updated, url: $url)';
  }
...
class _$_CommunitySafe extends _CommunitySafe {
  ...
  @override
  String toString() {
    return 'CommunitySafe(id: $id, name: $name, title: $title, description: $description, removed: $removed, published: $published, updated: $updated, deleted: $deleted, nsfw: $nsfw, actorId: $actorId, local: $local, icon: $icon, banner: $banner, hidden: $hidden, instanceId: $instanceId, postingRestrictedToMods: $postingRestrictedToMods)';
  }
...
abstract class _CommunitySafe extends CommunitySafe {
  const factory _CommunitySafe(
      ...
      required final bool postingRestrictedToMods}) = _$_CommunitySafe;
...
class _$_Comment extends _Comment {
  ...
  @override
  String toString() {
    return 'Comment(id: $id, creatorId: $creatorId, postId: $postId, content: $content, removed: $removed, published: $published, updated: $updated, deleted: $deleted, apId: $apId, local: $local, instanceHost: $instanceHost, languageId: $languageId, distinguished: $distinguished)';
  }
...
abstract class _Comment extends Comment {
  const factory _Comment(
      ...
      required final int languageId,
      required final bool distinguished}) = _$_Comment;
